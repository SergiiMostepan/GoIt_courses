...
const refs = {
  ...
  mapContainer: document.querySelector('.map-conteiner'),
};
...
function openMap() {
  refs.mapContainer.classList.toggle('visibleBlock');
  refs.openMapBtn.classList.toggle('openedMapBtn');
}
...
refs.openMapBtn.addEventListener('click', e => {
  openMap();
});
